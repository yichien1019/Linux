...
getmem=$(cat /proc/meminfo| grep "MemTotal" | cut -d ':' -f 2)
getroot=$(cd /root; du -sh)
...
➜  shell ./basic.sh
Hostname : yichien
Internal IP : 172.29.217.111
External IP : 59.124.240.11
CPU cores :  8
Memory Total :         7844724 kB
non-system account :
nobody  yichien  ycc  new_user  test
root-size : 13M .
Timezone : Asia/Taipei
Time : 2022/07/08 17:57:22
OS : Linux x86_64
